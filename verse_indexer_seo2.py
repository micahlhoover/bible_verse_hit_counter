...
BOOK_NAME = "Proverbs"
OUT_CSV = "proverbs_total_hits_dataforseo.csv"
...
# ============================================================
# PROVERBS CHAPTER -> VERSE COUNT
# ============================================================

# PROVERBS_VERSES_PER_CHAPTER: Dict[int, int] = {
#     1: 2
# }
...
def iter_refs() -> List[Tuple[int, int]]:
    ...
    for ch, count in PROVERBS_VERSES_PER_CHAPTER.items():
...
def main():
    refs = iter_refs()
    iterator = refs if tqdm is None else tqdm(refs, desc="DataForSEO totals (Proverbs)")
